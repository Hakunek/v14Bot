...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        const embed = {
            ...
            fields: [{ name: "\u200b", value: `${flag} **__${name.charAt(0).toUpperCase() + name.slice(1)} Rooms__** ${flag}\n\n${roomLinks}` }],
            thumbnail: {
...
//let buttons = fs.readdirSync("./");for(let buttonF of buttons){const button = require("./"+buttonF);console.dir(button,{depth:null, color:"auto"})}
