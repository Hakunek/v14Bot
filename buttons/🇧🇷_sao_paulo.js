...
module.exports = {
    ...
    async execute(interaction, client) {
        const rooms = client.cachedRooms.cache.sort((a, b) => a.roomId - b.roomId).filter((room) => room.region?.toLowerCase() == "sao paulo");
        ...
        const embed = {
            ...
            fields: [{ name: "\u200b", value: `${flag} **__Sao Paulo Rooms__** ${flag}\n\n${roomLinks}` }],
            thumbnail: {
